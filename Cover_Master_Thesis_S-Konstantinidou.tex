...
%Towards creating awareness for the formulation of space traffic management rules based on a satellite's added value
\end{center}
\vspace{2.2cm}
\begin{center}
...
%
%Should inform the reader (say in 300 words) about:
