...
\footnotetext{\label{foot}\textit{This value corresponds to the \# of cells along the longitude. It also needs to be mentioned that the units of "grid interval" and "new longitude" are degrees.}}
...
%which parameter is connected to the \textit{grid interval} and this to the swath width (Equation \ref{grid_interval}).
